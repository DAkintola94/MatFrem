    ...
    public class CartHelper
    {
            ...
            AppDBContext _context)
        {
            ...
            foreach (var pair in cartDictionary)
            {
                ...
                var productDbContext = _context.Product_detail.Find(productId);
                if (productDbContext == null) continue;

                var item = new OrderItem
                {       
                    Quantity = quantity,
                    UnitPrice = (decimal)productDbContext.ProductPrice,
